...
const FormData = require("form-data"); // أضفت لك هذه المكتبة لرفع الصور
...
// دالة جديدة كلياً لحل مشكلة الـ 404 عند إرسال الصور للعميل
...
app.post("/webhook", async (req, res) => {
  try {
    ...
    // رسائل الدعم -> Zammad (استقبال الصور من العميل)
